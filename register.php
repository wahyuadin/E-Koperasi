                                    ...
                                    <div class="card-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="nama" name="nama" type="text" placeholder="Masukan anda lengkap anda" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="email">Email Universitas</label>
                                                <input class="form-control py-4" id="email" name="email" type="email" placeholder="Masukan email instansi universitas anda" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="username">Username</label>
                                                <input class="form-control py-4" id="username" type="text" name="username" aria-describedby="emailHelp" placeholder="Masukan username anda" required>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
