...
<div class="card-header mb-5">
    ...
    <div class="form-group">
        ...
        <input type="text" name="tgl_pinjam" id="tgl_pinjam" class="form-control" value="<?= $tgl_pinjam ?>" disabled>
    </div>
    <div class="form-group">
        <label for="tgl_kembali">Tanggal Kembali</label>
        <input type="text" name="tgl_kembali" id="tgl_kembali" class="form-control" value="<?= $kembali ?>" disabled>
    </div>
    <div class="form-group">
